  ...
  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 backdrop-blur-[2px] p-3">
    ...
    >
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm font-semibold text-[#1B120D]">
              {client.telephone}
            </p>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0">
            ...
            <p className="text-sm font-semibold text-[#1B120D] break-all">
              {client.email}
            </p>
      ...
      <div className="flex items-center justify-between mb-3">
        ...
        <h3 className="font-semibold text-base text-[#1B120D]">
          Histórico
        </h3>
          ...
          {client.history.map((appointment) => (
            ...
            >
              ...
              <div className="min-w-0">
                ...
                <p className="text-sm font-semibold text-[#1B120D] truncate">
                  {appointment.service}
                </p>
